        ...
        <div className="card bg-base-100 shadow-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="form-control">
              ...
              <textarea
                {...register('descripton')}
                className={`textarea textarea-bordered h-32 ${errors.descripton && 'textarea-error'}`}
              />
              {errors.descripton && (
                <span className="text-error">{errors.descripton.message}</span>
              )}
            </div>
          ...
          <div className="space-y-4 mb-6">
            ...
            {visibleFields.map((field, index) => (
              <div key={field.id} className="border p-4 rounded-lg space-y-2">
                ...
                <textarea
                  {...register(`visibleTestCase.${index}.explanation`)}
