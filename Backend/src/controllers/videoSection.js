...
const generateUploadSignature = async (req, res) => {
    try {
        ...
        console.log('Eroor generating upload signature:', err);
...
const saveVideoMetadata = async (req, res) => {
    try {
        ...
        console.log("hi mohit here fuck you");
        ...
        if (existingVideo) {
            return res.status(409).json({ error: "Video already exist" });
        }
        ...
        console.log('Eroor saving video metadata:', error);
